...
# Create the parser
parser = argparse.ArgumentParser(prog="run_processphotomOneImage.py",usage="example : python run_processphotomOneImage.py --reposdir /sdf/home/d/dagoret/repos/repos_w_2022_39  --listofimages /sdf/home/d/dagoret/notebooks/AuxTelComm/notebooks_usdf/butlertools/all_visitdispersers/20220630/visitdispersers_20220630_filt_empty-holo4_003.list  --num 1 --outcoll u/dagoret/photo/empty~holo4_003/20220630")# Add an argument
...
DRP_PIPE_DIR=os.getenv(DRP_PIPE_DIR)
...
command_line="pipetask run -b /sdf/group/rubin/repo/main -p -p {}/pipelines/LATISS/DRP.yaml#isr,characterizeImage,calibrat -i LATISS/raw/all,refcats,LATISS/calib -o {} -d \"exposure.day_obs={} and exposure.seq_num={} and instrument='LATISS'\" --register-dataset-types --clobber-outputs -j 8".format(DRP_PIPE_DIR,outcoll,dateobs,seq)
