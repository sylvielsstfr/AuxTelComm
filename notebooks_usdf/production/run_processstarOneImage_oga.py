...
command_line="pipetask run -b /sdf/group/rubin/repo/oga -p {}/atmospec/pipelines/processStar.yaml -i
LATISS/raw/all,refcats,LATISS/calib -o {} -d \"exposure.day_obs={} and exposure.seq_num={} and
instrument='LATISS'\" --register-dataset-types --clobber-outputs -j 8".format(REPOSDIR,outcoll,dateobs,seq)
