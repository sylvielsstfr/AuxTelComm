...
#export REPOSDIR="repos/w_2022_39"
...
#export MYLISTOFEXPOSURES="all_visitsdispersers_gen3/visitdispersers_20210909_filt_empty-holo4_003.list"
#export MYLISTOFEXPOSURES="all_visitsdispersers_gen3/visitdispersers_20220609_filt_FELH0600-holo4_003.list"
#export MYLISTOFEXPOSURES="all_visitsdispersers_gen3/visitdispersers_20211103_filt_FELH0600-holo4_003.list"
export MYLISTOFEXPOSURES="all_visitsdispersers_gen3/visitdispersers_20211103_filt_empty-holo4_003.list"


source /cvmfs/sw.lsst.eu/linux-x86_64/lsst_distrib/w_2022_39/loadLSST.bash ; setup lsst_distrib
...
python run_processstarOneImage_gen3_v11.py --reposdir ${REPOSDIR} --listofimages ${MYLISTOFEXPOSURES} --num ${SLURM_ARRAY_TASK_ID}
