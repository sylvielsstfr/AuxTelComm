...
#export MYLISTOFEXPOSURES="all_visitsdispersers_gen3/visitdispersers_20220629_filt_FELH0600-holo4_003.list"
export MYLISTOFEXPOSURES="all_visitsdispersers_gen3/visitdispersers_20220629_filt_BG40-holo4_003.list"
...
python run_processstarOneImage_gen3_v9.py --reposdir ${REPOSDIR} --listofimages ${MYLISTOFEXPOSURES} --num ${SLURM_ARRAY_TASK_ID}
