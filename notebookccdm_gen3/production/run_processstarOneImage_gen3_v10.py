...
listofimages="all_visitsdispersers_gen3/visitdispersers_20220317_filt_empty-ronchi170lpmm.list"
...
#cmd1="pipetask run -b ./data -p {}/atmospec/pipelines/processStar.yaml -i LATISS/raw/all,refcats,LATISS/calib -o u/dagoret/first_test2".format(REPOSDIR)
#print(cmd1)
   
#cmd2="-d \"exposure.day_obs={} and exposure.seq_num={} and instrument='LATISS'\" --register-dataset-types --clobber-outputs".format(dateobs,seq)
#print(cmd2)
