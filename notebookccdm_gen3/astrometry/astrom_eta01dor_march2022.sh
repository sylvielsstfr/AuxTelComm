...
image="exposure_2022031600335_postisrccd.fits"

cmd="solve-field --scale-units arcsecperpix --scale-low 0.01 --scale-high 0.1 --ra $ra --dec $dec --radius 0.076 --overwrite --ext 1 -D . $path/$image"
